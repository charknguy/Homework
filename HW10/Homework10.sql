...
SELECT last_name
FROM actor
WHERE locate('G', last_name) AND locate('E', last_name) AND locate('N', last_name);

#2c. Find all actors whose last names contain the letters LI. This time, order the rows by last name and first name, in that order:

SELECT last_name, first_name
FROM actor
WHERE locate('L', last_name) AND locate('I', last_name);
...
address_id smallint(5) UN AI PK,
address varchar(50),
address2 varchar(50),
district varchar(20),
...
SELECT city, country, SUM(payment.amount) AS 'total_sales'
FROM payment
...
SELECT name, SUM(payment.amount) AS 'revenue'
FROM payment
JOIN rental ON payment.rental_id = rental.rental_id
JOIN inventory ON rental.inventory_id = inventory.inventory_id
